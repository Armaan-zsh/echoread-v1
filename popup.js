// --- JIT + HYBRID OCR SCRIPT (v5.1 - ES Module Edition) ---

// --- STEP 1: IMPORT LIBRARIES ---
// We can import pdf.mjs because it's a module
// Note: We use the full path from the extension root
import * as pdfjsLib from './pdf.mjs'; 

// Tesseract isn't a module, so we'll load it with a helper function
...
async function initializePdfViewer() {
  try {
    ...
    // pdfjsLib is now guaranteed to be defined because of the import
...
async function initializeOcr() {
  try {
    ...
    // Dynamically load Tesseract since it's not a module
